...
function Shop() {
  ...
  <div className="w-full md:w-3/5 lg:w-2/3 xl:w-1/2 mx-auto text-center mt-6">
    ...
    <p className="text-gray-700 mb-8">
      Discover our latest collection inspired by the late '90s and early 2000s
      styles. Comfortable, sustainable, and pantone-inspired colorways. Limited
      editions on ribbed items.
    </p>
  </div>
